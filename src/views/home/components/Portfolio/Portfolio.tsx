...
export function Portfolio() {
  ...
  return (
    <div className="w-full container mx-auto flex mt-0 lg:mt-44 flex-col gap-y-24 items-center">
      ...
      <div className="w-full rounded-[2rem] bg-purpleColor p-6 lg:p-8 flex flex-col-reverse gap-y-6 lg:flex-row gap-x-6">
        <div className="flex-1 max-w-xl max-h-[16rem] lg:max-h-none md:h-[40rem] bg-red-400 rounded-xl lg:rounded-[1.6rem] object-cover overflow-hidden">
          <Image
            src={Image1}
            alt="Imagem 1"
        ...
        <div className="flex-1 flex flex-col-reverse lg:flex-col h-full lg:h-[40rem] gap-6">
          <div className="w-full flex-1 min-h-[16rem] lg:h-[20rem] rounded-[1.6rem] object-cover overflow-hidden bg-white">
            <Image
              src={Image2}
              alt="Imagem 2"
          ...
          <div className="flex flex-col-reverse gap-y-6 lg:flex-row flex-1 items-center lg:max-h-72 gap-x-6">
            <div className="flex-1 w-full lg:w-auto min-h-[16rem] max-h-[16rem] bg-slate-500 overflow-hidden object-cover rounded-[1.6rem] lg:h-full">
              <Image
                src={Image3}
                alt="Imagem3"
                className="w-full  min-h-[16rem] lg:h-full object-cover"
            ...
            <div className="flex flex-col pr-0 lg:pr-12 gap-y-6">
